...
function GeneratePrimitiveDatatypes(workspace) {
    const promises = [];
    for (const datatype in primatives) {
        promises.push(new Promise((resolve, reject) => {
            fs_1.default.writeFile(path_1.default.join(workspace, 'datatypes', `${datatype}.ts`), primatives[datatype], (err) => {
                if (err) {
                    reject(err);
                }
                else {
...
exports.GeneratePrimitiveDatatypes = GeneratePrimitiveDatatypes;
